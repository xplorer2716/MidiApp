...
using MidiApp.MidiController.Extensions;
    ...
    public static class BugReportFactory
    {
        ...
        private static string CreateEnvironmentInfo()
        {
            ...
            if (assembly != null)
            {
                ...
                sb.AppendFormat("Assembly.Location: {0}\r\n", assembly.Location);
            }
                ...
                if (baseException != null)
                {
                    ...
                    if (deviceException != null)
                    {
                        ...
                        midiDetails = string.Format("MIDI error code is: {0} - {1}",
                            ...
                            deviceException.GetErrorMessageForErrorCode(deviceException.ErrorCode).ToUpper());
                    }
