namespace MidiApp.MidiController.View
{
     public partial class PianoControlForm
    {
        ...
        {
            this.pianoControl = new Sanford.Multimedia.Midi.UI.Windows.PianoControl();
            this.SuspendLayout();
            // 
            // pianoControl
            // 
            ...
            this.pianoControl.PianoKeyDown += new System.EventHandler<Sanford.Multimedia.Midi.UI.Windows.PianoKeyEventArgs>(this.pianoControl1_PianoKeyDown);
            this.pianoControl.PianoKeyUp += new System.EventHandler<Sanford.Multimedia.Midi.UI.Windows.PianoKeyEventArgs>(this.pianoControl1_PianoKeyUp);
            // 
            // PianoControlForm
            // 
        ...
        private Sanford.Multimedia.Midi.UI.Windows.PianoControl pianoControl;
